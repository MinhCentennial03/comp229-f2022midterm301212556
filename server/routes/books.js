...
router.post('/add', (req, res, next) => {
     ...
     *****************/
     ...
     const newBook = new book({Title,Price,Author,Genre,Description,});
...
router.get('/:id', (req, res, next) => {
     ...
     *****************/
     router.get("/:id", (req, res, next) => {
      ...
      // set an appropriate title property value
      let id = req.params.id;
      book.findById(id, (err, bookToEdit) => {
        if (err) res.end(err);
        else {
          res.render("books/details", {title: "Book list",books: bookToEdit,
          });
        }
      });
    });
...
router.post('/:id', (req, res, next) => {
     ...
     * ADD CODE HERE *
     *****************/
    //instantiate an object of the book model
     let id = req.params.id;
